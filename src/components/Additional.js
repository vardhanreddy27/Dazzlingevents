...
function Additional() {
  return (
    <div>
        ...
        <div className='col llol'><h4 className='mb-5'><img src='./p.png' className='lkm'/><br></br><br></br>Maternity Photoshoot</h4></div> 
         <div className='col llol'><h4 className='mb-5'><img src='./child.png' className='baby'/><br></br><br></br>Baby Photoshoot</h4></div>
         <div className='col llol'><h4 className='mb-5'><img src='./model.png' className='model'/><br></br><br></br>Modeling Photoshoot </h4></div>        </div>
     <div className='row'>
     <div className='col-3'>
